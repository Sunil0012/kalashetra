    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 pb-20 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-16 border-t border-border pt-16">
        ...
        <div className="space-y-6 text-[15px] leading-relaxed">
          <p>
            ...
            print, and works on paper. We work directly with artists, estates, and and
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 pb-24 border-t border-border pt-16">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            { name: "Mara Lindqvist", role: "Head of Sale", focus: "Painting & drawings" },
            { name: "Jonas Vrest", role: "Specialist", focus: "Prints & works on paper" },
            { name: "Aïcha Bensaïd", role: "Specialist", focus: "Drawings & studies" },
          ].map((p) => (
            <div key={p.name}>
