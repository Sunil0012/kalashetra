...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated seasonal sales of paintings, drawings, and prints. Bid online with confidence." },
      { property: "og:title", content: "Kalashetra — Fine Art Auctions" },
      { property: "og:description", content: "Curated seasonal sales of paintings, drawings, and prints." },
    ],
  }),
  component: HomePage,
});
